      ...
      <header className="bg-white border-b sticky top-0 z-20 p-4">
        <div className="max-w-5xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <Input 
              placeholder="エリア（大阪、東京、世田谷など）で検索..." 
          ...
          <div className="flex bg-slate-100 p-1 rounded-xl">
            <Button 
              ...
              className={`rounded-lg text-xs font-bold gap-1 ${viewMode === "list" ? "bg-[#1D3557] text-white" : "text-slate-500"}`}
            >
              <List size={14} /> リスト
            </Button>
            <Button 
              ...
              className={`rounded-lg text-xs font-bold gap-1 ${viewMode === "map" ? "bg-[#E63946] text-white" : "text-slate-500"}`}
            >
              <Map size={14} /> 地図で確認
            </Button>
          </div>
              ...
              <Card key={school.id} className="border-none shadow-md rounded-3xl overflow-hidden bg-white p-4 space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <a 
                    ...
                    className="text-xs text-[#E63946] font-bold flex items-center gap-1 hover:underline"
                  >
              ...
              <Card key={school.id} className="hover:shadow-md transition-all border-none bg-white shadow-sm overflow-hidden group">
                <div className="p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 text-slate-400 text-xs mb-1 font-bold">
                      ...
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="text-slate-400 hover:text-[#E63946] flex items-center gap-0.5 text-[10px] underline"
                      >
                        地図アプリで開く <ExternalLink size={10} />
                      </a>
                    </div>
                  ...
                  <div className="text-right w-full md:w-auto md:min-w-[180px] border-t md:border-t-0 md:border-l pt-4 md:pt-0 md:pl-8">
                    ...
                    <Link href={`/search/${school.id}`}>
                      <Button className="bg-[#1D3557] w-full md:w-32 hover:bg-[#E63946] transition-all rounded-full flex items-center justify-center gap-2 group-hover:shadow-lg group-hover:shadow-red-200 text-white font-bold">

...
const SCHOOL_DETAILS: Record<string, any> = {
  "1": { 
    ...
    price: "15,000円", 
    image: "/lesson.jpg",
    desc: "20代〜30代の生徒が多数在籍。若手講師が伝統の所作を分かりやすく指導します。"
  },
  "2": { 
    name: "H 教室", 
    location: "兵庫県 伊丹市", 
    ...
    price: "12,000円", 
    image: "/rental.jpg",
    desc: "「手ぶらで1日」がコンセプト。豊富な稽古着から好きな柄を選んで体験できます。"
  },
  "3": { 
    name: "K 教室", 
    location: "東京・世田谷", 
    ...
    price: "18,000円", 
    image: "/hero.jpg",
    desc: "伝統を大切にしつつ、親しみやすい本格邦楽で基本を学べる世田谷の教室です。"
  }
};
        ...
        <div className="md:col-span-2 space-y-10">
          <section className="space-y-4">
            ...
            <p className="text-slate-600 leading-relaxed text-sm font-medium">
              {school.desc} 事前のオンデマンド動画で流派の歴史や作法を予習し、当日は手ぶらで60分の対面稽古に没頭します。
            </p>
          </section>
            ...
            <CardContent className="p-6 space-y-6">
              ...
              {step === 3 && (
                <div className="text-center py-4 space-y-4">
                  ...
                  <h3 className="font-bold text-lg">1日体験の申込が完了しました！</h3>
                  <div className="bg-red-50 p-4 rounded-2xl text-left space-y-2 border border-red-100">
                    ...
                    <p className="text-[11px] text-slate-600">ご入力いただいたメールアドレスに「事前解説動画」のURLを送信しました。当日までに動画をチェックしてください。</p>
                  </div>
